        ...
        {statItems.map((item) => (
          <a
            ...
            className={`
              ...
              ${item.highlight
                ? 'border-devcard-green/30 bg-devcard-green/5 hover:bg-devcard-green/10 hover:border-devcard-green/50 hover:shadow-lg hover:shadow-devcard-green/10'
          ...
          >
            ...
            <div className="flex flex-col items-center gap-0.5">
              <span className={`text-2xl font-bold ${
                item.highlight ? 'text-devcard-green' : 'text-foreground'
              }`}>
                {item.value}
              </span>
